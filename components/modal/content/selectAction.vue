<template>
  <div>
    <div class="mt-2">
      <div v-if="hasPremium">
        ...
        <div class="flex columns-2 w-full mb-2 place-items-center" @click="isClose()">
          <Icon name="ph:lightning-fill" color="D19D38" size="" class="gold circle-icon" />
    ...
    <div class="mt-5" @click="copyToken(user.invitation_token)">
      <div class="flex columns-2 w-full mb-2 place-items-center">
        <Icon name="ph:user-circle-plus-fill" color="26AB22" size="" class="green circle-icon" />
    ...
    <div class="mt-5" @click="$emit('close')">
      <NuxtLink to="/panel/konto/srodki">
        <div class="flex columns-2 w-full mb-2 place-items-center">
          <Icon name="ph:wallet-fill" color="2B3BC7" size="" class="blue circle-icon" />
